	...
	public SearchPanel(String category,JFrame mainFrame){
		...
		*/
		...
		if(category=="player"){
			...
			playerbtn_1.setBounds(38, 92, 62, 50);
			playerbtn_1.addActionListener(e->showPlayerInfo(pName));
			add(playerbtn_1);
			
			JButton playerbtn_2 = new JButton("");
			playerbtn_2.setBounds(38, 144, 62, 50);
			add(playerbtn_2);
			
			JButton playerbtn_3 = new JButton("");
			playerbtn_3.setBounds(38, 196, 62, 50);
			add(playerbtn_3);
			
			JButton playerbtn_4 = new JButton("");
			playerbtn_4.setBounds(38, 300, 62, 50);
			add(playerbtn_4);
			
			JButton playerbtn_6 = new JButton("");
			playerbtn_6.setBounds(38, 248, 62, 50);
			add(playerbtn_6);
			
			JButton playerbtn_7= new JButton("");
			playerbtn_7.setBounds(38, 352, 62, 50);
			add(playerbtn_7);
			
			JButton leftbtn_1 = new JButton("L");
			leftbtn_1.setBounds(40, 51, 59, 37);
			add(leftbtn_1);
			
			JButton rightbtn_1 = new JButton("R");
			rightbtn_1.setBounds(40, 404, 59, 37);
			add(rightbtn_1);
