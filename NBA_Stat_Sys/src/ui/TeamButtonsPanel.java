...
public class TeamButtonsPanel extends JPanel {
	...
	public TeamButtonsPanel(int X, int Y, JFrame mainFrame, JPanel previousPanel,String previouspanel) {
		this.X = X;
		this.Y = Y;
