...
public class SortPanel extends JPanel {
	...
	public SortPanel(String category, JFrame mainFrame) {
		...
		if (category == "player") {
			...
			playerCriteriabtn.setBounds(X*29/100, Y/8,  X*31/100, X/50);
		...
		if (category == "team") {
			...
			teamCriteriabtn.setBounds(X*29/100, Y/8,  X*31/100, X/50);
	...
	public void sortPlayer(String UpOrDown) {
		...
		for (int i = 0; i < playerVos.size(); i++) {
			...
			case "gameNum":
				a.add(new PlayerCardPanel(X,Y,playerVos.get(i), playerCriteriabtn
	...
	public void sortTeam(String UpOrDown) {
		...
		for (int i = 0; i < teamVos.size(); i++) {
			...
			switch (teamCriteria) {
			case "GameNum":
				a.add(new TeamCardPanel(X,Y,teamVos.get(i), teamCriteriabtn
	...
	public class SortPlayerCriteriaPanel extends JPanel {
		public SortPlayerCriteriaPanel() {
			this.setLayout(null);
			this.setVisible(true);
			this.setBounds(X*29/100, Y/8+X/50,  X*31/100, X*16/100);
			
			ButtonGroup bg = new ButtonGroup();
			
			JRadioButton rdbtnNewRadioButton = new JRadioButton("参赛场数");
			rdbtnNewRadioButton.setBounds(0, Y*6/768, X*29/400, X*15/700);
			rdbtnNewRadioButton
			...
			rdbtnNewRadioButton_1.setBounds(X*31/400, Y*6/768,  X*29/400, X*15/700);
			...
			rdbtnNewRadioButton_5.setBounds(X*93/400,Y*6/768,X*29/400, X*15/700);
			...
			rdbtnNewRadioButton_2.setBounds(X*62/400, Y*31/768,  X*29/400, X*15/700);
			...
			rdbtnNewRadioButton_3.setBounds(X*93/400, Y*31/768,  X*29/400, X*15/700);
			...
			rdbtnNewRadioButton_4.setBounds(X*62/400, Y*6/768, X*29/400, X*15/700);
			...
			radioButton.setBounds(0, Y*156/768, X*29/400, X*15/700);
			...
			radioButton_1.setBounds(X*31/400, Y*156/768, X*29/400, X*15/700);
			...
			radioButton_2.setBounds(X*62/400, Y*156/768, X*29/400, X*15/700);
			...
			radioButton_3.setBounds(0, Y*31/768, X*29/400, X*15/700);
			...
			radioButton_4.setBounds(X*31/400, Y*31/768,X*29/400, X*15/700);
			...
			radioButton_5.setBounds(0, Y*56/768, X*29/400, X*15/700);
			...
			radioButton_6.setBounds(X*31/400, Y*56/768, X*29/400, X*15/700);
			...
			radioButton_7.setBounds(X*62/400, Y*56/768, X*29/400, X*15/700);
			...
			radioButton_8.setBounds(X*93/400, Y*56/768, X*29/400, X*15/700);
			...
			radioButton_9.setBounds(0, Y*81/768, X*29/400, X*15/700);
			radioButton_9
			...
			radioButton_10.setBounds(X*62/400, Y*131/768, X*29/400, X*15/700);
			...
			rdbtnGmsc.setBounds(X*31/400, Y*81/768, X*29/400, X*15/700);
			...
			radioButton_11.setBounds(X*93/400, Y*131/768, X*29/400, X*15/700);
			...
			radioButton_12.setBounds(X*62/400, Y*81/768, X*29/400, X*15/700);
			...
			radioButton_13.setBounds(X*93/400, Y*81/768,X*29/400, X*15/700);
			...
			radioButton_14.setBounds(0, Y*106/768, X*29/400, X*15/700);
			...
			radioButton_15.setBounds(X*31/400, Y*106/768, X*29/400, X*15/700);
			...
			radioButton_16.setBounds(X*62/400, Y*106/768, X*29/400, X*15/700);
			...
			radioButton_17.setBounds(X*93/400, Y*106/768, X*29/400, X*15/700);
			...
			radioButton_18.setBounds(0, Y*131/768, X*29/400, X*15/700);
			...
			radioButton_19.setBounds(X*31/400, Y*131/768, X*29/400, X*15/700);
	...
	public class SortTeamCriteriaPanel extends JPanel {
		public SortTeamCriteriaPanel() {
			...
			radioButton_2.setBounds(X*31/400, Y*31/768, X*29/400, X*15/700);
			...
			radioButton_3.setBounds(X*62/400,Y*31/768, X*29/400, X*15/700);
			...
			radioButton_4.setBounds(X*93/400,Y*31/768, X*29/400, X*15/700);
			...
			radioButton_7.setBounds(X*31/400,Y*6/768, X*29/400, X*15/700);
			...
			radioButton_8.setBounds(X*62/400,Y*6/768, X*29/400, X*15/700);
			...
			radioButton_9.setBounds(X*93/400,Y*6/768, X*29/400, X*15/700);
			...
			radioButton_10.setBounds(X*62/400,Y*56/768, X*29/400, X*15/700);
			...
			radioButton_11.setBounds(X*93/400,Y*56/768, X*29/400, X*15/700);
			...
			radioButton_12.setBounds(0,Y*81/768, X*29/400, X*15/700);
			...
			radioButton_13.setBounds(X*31/400,Y*81/768, X*29/400, X*15/700);
			...
			radioButton_14.setBounds(X*62/400,Y*81/768, X*29/400, X*15/700);
			...
			radioButton_15.setBounds(X*93/400,Y*81/768, X*29/400, X*15/700);
			...
			radioButton_16.setBounds(0,Y*106/768, X*29/400, X*15/700);
			...
			radioButton_17.setBounds(X*31/400,Y*106/768, X*29/400, X*15/700);
			...
			radioButton_18.setBounds(X*62/400,Y*106/768, X*29/400, X*15/700);
			...
			radioButton_19.setBounds(X*93/400,Y*106/768, X*29/400, X*15/700);
			...
			radioButton_20.setBounds(0,Y*131/768, X*29/400, X*15/700);
			...
			radioButton_21.setBounds(X*31/400,Y*131/768, X*29/400, X*15/700);
			...
			radioButton_22.setBounds(X*62/400,Y*131/768, X*29/400, X*15/700);
			...
			radioButton_23.setBounds(X*93/400,Y*131/768, X*29/400, X*15/700);
			...
			radioButton_24.setBounds(0,Y*156/768, X*29/400, X*15/700);
			...
			radioButton_25.setBounds(X*31/400,Y*156/768, X*29/400, X*15/700);
...
//			System.out.println(((PlayerCardPanel)value).getPlayerInfo().getName());
	...
	class TeamCardRenderer implements TableCellRenderer{
		...
		public Component getTableCellRendererComponent(JTable table,
			...
			TeamCardPanel renderer=new TeamCardPanel(X,Y,((TeamCardPanel)value).getTeamInfo(),((TeamCardPanel)value).getCriteria(),((TeamCardPanel)value).getCriteriaValue());
			renderer.fillPanel();
