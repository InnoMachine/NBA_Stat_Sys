...
public class PlayerCardPanel extends JPanel {
	...
	public PlayerCardPanel(int number, int X, int Y, PlayerVo playerInfo, String criteria1, String criteriaValue1) {
		this.X = X;
		this.Y = Y;
		this.number = number;
	...
	public PlayerCardPanel(int number, int X, int Y, PlayerVo playerInfo, String criteria1, String criteriaValue1,
			String criteria2, String criteriaValue2) {
		this.X = X;
		this.Y = Y;
		this.number = number;
		this.setVisible(true);
	...
	public void fillPanel() {
		...
		lblNumber.setBounds(X * 6 / 1366, Y * 6 / 768, X * 63 / 1366, Y * 108 / 768);
		...
		playerButton.setBounds(X * 77 / 1366, Y * 6 / 768, X * 134 / 1366, Y * 108 / 768);
		...
		if (hasPortrait(playerInfo.getName() + ".png")) {
			playerPortrait = new ImageIcon(new ImageIcon("CSEdata/players/portrait/" + playerInfo.getName() + ".png")
					.getImage().getScaledInstance(X * 134 / 1366, Y * 108 / 768, Image.SCALE_AREA_AVERAGING));
		} else {
			playerPortrait = new ImageIcon(new ImageIcon("CSEdata/players/portrait/" + "DefaultPortrait" + ".png")
					.getImage().getScaledInstance(X * 134 / 1366, Y * 108 / 768, Image.SCALE_AREA_AVERAGING));
		}
		...
		label.setBounds(X * 220 / 1366, Y * 21 / 768, X * 54 / 1366, Y * 15 / 768);
		add(label);
		...
		txtA.setBounds(X * 254 / 1366, Y * 17 / 768, X * 184 / 1366, Y * 23 / 768);
		add(txtA);
		txtA.setColumns(10);
		...
		lblNewLabel_1.setBounds(X * 484 / 1366, Y * 21 / 768, X * 90 / 1366, Y * 15 / 768);
		add(lblNewLabel_1);
		...
		textField_8.setBounds(X * 581 / 1366, Y * 17 / 768, X * 80 / 1366, Y * 23 / 768);
		add(textField_8);
		...
		if (criteria2 != "") {
			...
			lblNewLabel_2.setBounds(X * 707 / 1366, Y * 21 / 768, X * 90 / 1366, Y * 15 / 768);
			add(lblNewLabel_2);
			...
			textField_9.setBounds(X * 804 / 1366, Y * 17 / 768, X * 80 / 1366, Y * 23 / 768);
			add(textField_9);
		...
		label_1.setBounds(X * 670 / 1366, Y * 56 / 768, X * 60 / 1366, Y * 15 / 768);
		add(label_1);
		...
		textField_4.setBounds(X * 728 / 1366, Y * 52 / 768, X * 80 / 1366, Y * 23 / 768);
		add(textField_4);

		MyLabel label_2 = new MyLabel(Color.WHITE, "位置");
		label_2.setBounds(X * 520 / 1366, Y * 56 / 768, X * 35 / 1366, Y * 15 / 768);
		add(label_2);
		...
		textField_6.setBounds(X * 554 / 1366, Y * 52 / 768, X * 80 / 1366, Y * 23 / 768);
		add(textField_6);

		MyLabel label_3 = new MyLabel(Color.WHITE, "身高");
		label_3.setBounds(X * 220 / 1366, Y * 56 / 768, X * 35 / 1366, Y * 15 / 768);
		add(label_3);
		...
		textField.setBounds(X * 254 / 1366, Y * 52 / 768, X * 80 / 1366, Y * 23 / 768);
		add(textField);
		textField.setColumns(10);

		MyLabel label_4 = new MyLabel(Color.WHITE, "体重");
		label_4.setBounds(X * 370 / 1366, Y * 56 / 768, X * 35 / 1366, Y * 15 / 768);
		add(label_4);
		...
		textField_2.setBounds(X * 404 / 1366, Y * 52 / 768, X * 80 / 1366, Y * 23 / 768);
		add(textField_2);

		MyLabel label_5 = new MyLabel(Color.WHITE, "生日");
		label_5.setBounds(X * 220 / 1366, Y * 91 / 768, X * 35 / 1366, Y * 15 / 768);
		add(label_5);
		...
		textField_1.setBounds(X * 254 / 1366, Y * 87 / 768, X * 90 / 1366, Y * 23 / 768);
		textField_1.setFont(new Font("黑体", 1, 11));
		add(textField_1);

		MyLabel label_6 = new MyLabel(Color.WHITE, "年龄");
		label_6.setBounds(X * 370 / 1366, Y * 91 / 768, X * 35 / 1366, Y * 15 / 768);
		add(label_6);
		...
		textField_3.setBounds(X * 404 / 1366, Y * 87 / 768, X * 80 / 1366, Y * 23 / 768);
		add(textField_3);

		MyLabel label_7 = new MyLabel(Color.WHITE, "球龄");
		label_7.setBounds(X * 520 / 1366, Y * 91 / 768, X * 35 / 1366, Y * 15 / 768);
		add(label_7);
		...
		textField_5.setBounds(X * 554 / 1366, Y * 87 / 768, X * 80 / 1366, Y * 23 / 768);
		add(textField_5);

		MyLabel label_8 = new MyLabel(Color.WHITE, "毕业学校");
		label_8.setBounds(X * 670 / 1366, Y * 91 / 768, X * 60 / 1366, Y * 15 / 768);
		add(label_8);

		textField_7 = new MyTextField(Color.WHITE);
		textField_7.setHorizontalAlignment(SwingConstants.CENTER);
		if (playerInfo.getSchool() != null) {
			if (playerInfo.getSchool().length() <= 18) {
				textField_7.setText(playerInfo.getSchool());
			} else {
				textField_7.setText(playerInfo.getSchool().substring(0, 18));
			}
		}

		// textField_7.setText(playerInfo.getSchool().length());
		textField_7.setEditable(false);
		textField_7.setColumns(10);
		textField_7.setBounds(X * 728 / 1366, Y * 87 / 768, X * 160 / 1366, Y * 23 / 768);
